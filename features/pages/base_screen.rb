...
class BaseScreen
    ...
    #Método para consultar e retornar se o mesmo está clicável. Mapeado com Class.
    def find_class_get_clickable(tipo)
        @driver.find_element(class: tipo).attribute('clickable')
    end
